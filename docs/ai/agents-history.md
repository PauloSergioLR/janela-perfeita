# Histórico antigo do AGENTS.md

Este arquivo guarda o conteúdo antigo do AGENTS.md apenas como referência histórica.

Não consulte este arquivo automaticamente durante execução de issues.
Use somente se o usuário pedir explicitamente contexto histórico do projeto.
